...
def _map_flake8_severity(code: str) -> str:
    ...
    medium_codes = {
        "F401", "F402", "F403", "F405", "F541", "F621", "F622", "F631",
        "F707", "F722", "F822", "E701", "E702", "E711", "E712", "E302",
        "E305", "E401", "E402",
    }
    if code in high_codes:
        return "high"
    if code in medium_codes or code.startswith("F"):
        return "medium"
    return "low"
...
def normalize_flake8(raw: Any) -> Dict[str, Any]:
    ...
    return {"tool": "flake8", "issues": issues, "counts": {"total": len(issues)}}
...
def normalize_bandit(raw: Any) -> Dict[str, Any]:
    ...
    return {"tool": "bandit", "loc": loc, "issues": issues, "counts": {"total": len(issues)}}
